...
Friend Module P01_Strategy
  ...
  Sub OO_130_Stg_Init()
    ...
    Stg_List.Add(New Stg_Cls("Cdd", "C", "O", "N", "N", "Stratégie des Candidats"))
    ...
    Stg_List.Add(New Stg_Cls("CdU", "U", "O", "I", "O", "Stratégie des Candidats Uniques"))
    Stg_List.Add(New Stg_Cls("CdO", "O", "O", "I", "O", "Stratégie des Candidats Obligatoires"))
    Stg_List.Add(New Stg_Cls("DCd", "N", "N", "I", "N", "Stratégie des Derniers Candidats"))
    Stg_List.Add(New Stg_Cls("CdS", "N", "N", "I", "N", "Stratégie du Candidat Saisi"))
    Stg_List.Add(New Stg_Cls("Flt", "N", "N", "N", "N", "Stratégie des Filtres"))
    Stg_List.Add(New Stg_Cls("FV1", "N", "N", "N", "N", "Filtre des Valeurs 1"))
    Stg_List.Add(New Stg_Cls("FV2", "N", "N", "N", "N", "Filtre des Valeurs 2"))
    Stg_List.Add(New Stg_Cls("FV3", "N", "N", "N", "N", "Filtre des Valeurs 3"))
    Stg_List.Add(New Stg_Cls("FV4", "N", "N", "N", "N", "Filtre des Valeurs 4"))
    Stg_List.Add(New Stg_Cls("FV5", "N", "N", "N", "N", "Filtre des Valeurs 5"))
    Stg_List.Add(New Stg_Cls("FV6", "N", "N", "N", "N", "Filtre des Valeurs 6"))
    Stg_List.Add(New Stg_Cls("FV7", "N", "N", "N", "N", "Filtre des Valeurs 7"))
    Stg_List.Add(New Stg_Cls("FV8", "N", "N", "N", "N", "Filtre des Valeurs 8"))
    Stg_List.Add(New Stg_Cls("FV9", "N", "N", "N", "N", "Filtre des Valeurs 9"))
    Stg_List.Add(New Stg_Cls("FC1", "N", "N", "N", "N", "Filtre des Candidats 1"))
    Stg_List.Add(New Stg_Cls("FC2", "N", "N", "N", "N", "Filtre des Candidats 2"))
    Stg_List.Add(New Stg_Cls("FC3", "N", "N", "N", "N", "Filtre des Candidats 3"))
    Stg_List.Add(New Stg_Cls("FC4", "N", "N", "N", "N", "Filtre des Candidats 4"))
    Stg_List.Add(New Stg_Cls("FC5", "N", "N", "N", "N", "Filtre des Candidats 5"))
    Stg_List.Add(New Stg_Cls("FC6", "N", "N", "N", "N", "Filtre des Candidats 6"))
    Stg_List.Add(New Stg_Cls("FC7", "N", "N", "N", "N", "Filtre des Candidats 7"))
    Stg_List.Add(New Stg_Cls("FC8", "N", "N", "N", "N", "Filtre des Candidats 8"))
    Stg_List.Add(New Stg_Cls("FC9", "N", "N", "N", "N", "Filtre des Candidats 9"))
    '                                N pas de lettre
    Stg_List.Add(New Stg_Cls("Obj", "N", "N", "N", "N", "Dessiner sur la Grille"))
    Stg_List.Add(New Stg_Cls("Edi", "N", "N", "N", "N", "Edition de la Grille"))
    Stg_List.Add(New Stg_Cls("Cbl", "B", "O", "E", "O", "Stratégie des Candidats bloqués"))
    Stg_List.Add(New Stg_Cls("Tpl", "T", "O", "E", "O", "Stratégie des Candidats doubles, triples, quadruples"))
    Stg_List.Add(New Stg_Cls("Xwg", "X", "O", "E", "O", "Stratégie X-Wing, Finned, Sashimi"))
    Stg_List.Add(New Stg_Cls("XYw", "Y", "O", "E", "O", "Stratégie XY-Wing"))
    Stg_List.Add(New Stg_Cls("Swf", "S", "O", "E", "O", "Stratégie Swordfish"))
    Stg_List.Add(New Stg_Cls("Jly", "J", "O", "E", "O", "Stratégie Jellyfish"))
    Stg_List.Add(New Stg_Cls("XYZ", "Z", "O", "E", "O", "Stratégie XYZ-Wing"))
    Stg_List.Add(New Stg_Cls("SKy", "K", "O", "E", "O", "Stratégie SKyscraper, Kyte, Empty Rectangle"))
    Stg_List.Add(New Stg_Cls("Unq", "Q", "O", "E", "O", "Stratégie Uniqueness"))

    ' Les codes des nouvelles stratégies des Liens commencent par X ou W
    '                                la lettre est L Link
    Stg_List.Add(New Stg_Cls("GLk", "N", "N", "E", "N", "Affichage des Liens forts"))
    Stg_List.Add(New Stg_Cls("Gbl", "L", "N", "E", "N", "Stratégie bi-locaux (Candidats bloqués)"))
    Stg_List.Add(New Stg_Cls("Gbv", "L", "N", "E", "N", "Stratégie bi-values"))
    Stg_List.Add(New Stg_Cls("GCs", "L", "N", "E", "N", "Stratégie DFS Coloration Simple"))
    Stg_List.Add(New Stg_Cls("XCx", "L", "N", "E", "N", "Stratégie X-Chain"))
    Stg_List.Add(New Stg_Cls("XCy", "L", "N", "E", "N", "Stratégie XY-Chain"))
    Stg_List.Add(New Stg_Cls("XRp", "L", "N", "E", "N", "Stratégie Remote Pairs"))
    Stg_List.Add(New Stg_Cls("XNl", "L", "N", "E", "N", "Stratégie Nice_Loop"))
    Stg_List.Add(New Stg_Cls("WgX", "L", "N", "E", "N", "Stratégie X-Wing"))
    Stg_List.Add(New Stg_Cls("WgY", "L", "N", "E", "N", "Stratégie XY-Wing"))
    Stg_List.Add(New Stg_Cls("WgZ", "L", "N", "E", "N", "Stratégie XYZ-Wing"))
    Stg_List.Add(New Stg_Cls("WgW", "L", "N", "E", "N", "Stratégie W-Wing"))
  ...
  Sub Stg_List_Display()
    ...
    For i As Integer = 0 To Stg_List.Count - 1
      With Stg_List.Item(i)
        Jrn_Add(, {CStr(i).PadRight(3) & " " & .Code & " " & .Lettre & " " & .Dsp_BO & " " & .Type & " " & .Prd & " " & .Texte})
      End With
    Next i
    Dim S As String = ""
