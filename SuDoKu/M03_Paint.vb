  ...
  Public Sub U_Strg_Effacer()
    ...
    For i As Integer = 0 To 80
      If U_Strg(i) Then
        ...
        sc.G6_Cellule_Paint_Candidats_Conditions_Sas_Nrm_Cdd() ' dans le cas où seul un candidat a été exclu
      End If
      U_Strg(i) = False
    Next i
  End Sub
...
#Region "G1 Couche Quadrillage"
    ...
    For i As Integer = 0 To 9
      ...
      Select Case i
        Case 0, 3, 6, 9        '  Trait de 3
          g.DrawLine(New Pen(Color_Frm_BackColor, Bld_Trait_3), Pt_H1, Pt_H2)
          g.DrawLine(New Pen(Color_Trait, Bld_Trait_3), Pt_H1, Pt_H2)
          g.DrawLine(New Pen(Color_Frm_BackColor, Bld_Trait_3), Pt_V1, Pt_V2)
          g.DrawLine(New Pen(Color_Trait, Bld_Trait_3), Pt_V1, Pt_V2)
        Case 1, 2, 4, 5, 7, 8  '  Trait de 1
          g.DrawLine(New Pen(Color_Frm_BackColor, Bld_Trait_1), Pt_H1, Pt_H2)
          g.DrawLine(New Pen(Color_Trait, Bld_Trait_1), Pt_H1, Pt_H2)
          g.DrawLine(New Pen(Color_Frm_BackColor, Bld_Trait_1), Pt_V1, Pt_V2)
          g.DrawLine(New Pen(Color_Trait, Bld_Trait_1), Pt_V1, Pt_V2)
      End Select
    Next i
  End Sub
  Public Sub G1_Grid_Paint_Quadrillage_04(g As Graphics)
    ...
    End Select
    ' 2 Entourage avec coins arrondis ou biseautés
    g.DrawPath(New Pen(Color_Frm_BackColor, Bld_Trait_3), Grid_Pth)
    g.DrawPath(New Pen(Color_Trait, Bld_Trait_3), Grid_Pth)
    Grid_Pth.Dispose()
  End Sub
  Public Sub G1_Grid_Paint_Quadrillage_20(g As Graphics)
    ...
    For Région As Integer = 0 To 8
      ...
      Reg_Pth(Région) = New GraphicsPath
      ...
      g.DrawPath(New Pen(Color_Frm_BackColor, Bld_Trait_3), Reg_Pth(Région))
      g.DrawPath(New Pen(Color_Trait, Bld_Trait_3), Reg_Pth(Région))
      Reg_Pth(Région).Dispose()
    Next Région
  End Sub
      ...
      Try
        ...
        If Plcy_AideGraphique And Valeur_Existante_dans_la_Région = False Then
          ...
          If n = 1 Then
            ...
            sc.G6_Cellule_Paint_Candidat(Valeur_Filtrée, Color_Cdd_Insérer)
    ...
    If Plcy_Gnrl = "Nrm" And Mid$(Plcy_Strg, 1, 2) = "FC" Then
      Try
        ...
        For i As Integer = 0 To 80
          ...
          U_Strg(i) = True
          If U(i, 3).Contains(Candidat) Then sc.G6_Cellule_Paint_Candidat(Candidat, Color)
        Next i
      Catch ex As Exception
        Jrn_Add("ERR_00000", {ex.Message}, "Erreur")
        Jrn_Add("ERR_00000", {ex.ToString()}, "Erreur")
  ...
  Public Sub G4_Grid_Stratégie_DCd()
    ...
    Try
      ...
      If DCdd_List_Exists(Pbl_Cell_Select) And Plcy_AideGraphique Then
        ...
        '  'Re-dessine le candidat à placer dans un cercle plein Jaune
        Dim sc As New Cellule_Cls With {.Numéro = Pbl_Cell_Select}
        sc.G6_Cellule_Paint_Candidat(DCdd2.Candidat, Color_Cdd_Insérer)
        U_Strg(Cellule) = True
    ...
    Try
      ...
      If Ligne <> -1 And Plcy_AideGraphique Then
        ...
        For k As Integer = 55 To 99    ' Re-dessine le candidat à enlever dans un cercle plein rouge
          ...
          sc_Cdd.G6_Cellule_Paint_Candidat(Candidat, Color_Cdd_Exclure)
          U_Strg(Cellule) = True
        Next k
      ...
      If Ligne <> -1 And Plcy_AideGraphique Then
        ...
        For i As Integer = 0 To 80
          If U_temp(i, 3).Contains(Candidat) Then
            ...
            sc_a.G6_Cellule_Paint_Candidat(Candidat, Color_Stratégique)
          End If
        Next i
        ...
        For k As Integer = 55 To 99    ' Re-dessine le candidat à enlever dans un cercle plein rouge
          ...
          For c As Integer = 1 To 9
            If Mid$(Candidats, c, 1) = CStr(c) Then
              sc_Cdd.G6_Cellule_Paint_Candidat(CStr(c), Color_Cdd_Exclure)
      ...
      For Each XCelExcl As XCel_Excl_Cls In XRslt.CelExcl
        With XCelExcl
          ...
          If U(.Cel, 3).Contains(.Cdd) Then
            sc.G6_Cellule_Paint_Candidat(.Cdd, Color_Cdd_Exclure)
    ...
    Try
      ...
      For Each gLink As GLink_Cls In GLinks
        ...
        If U(gLink.Cel(1), 3).Contains(gLink.Cdd(2)) Then
          sc_gLink.G6_Cellule_Paint_Candidat(gLink.Cdd(2), Color_Link_S)
        End If
      Next gLink
    ...
    Try
      ...
      For Each gLink As GLink_Cls In GRslt.RoadRight
        ...
        If U(gLink.Cel(1), 3).Contains(gLink.Cdd(3)) Then
          sc_gLink2.G6_Cellule_Paint_Candidat(gLink.Cdd(3), Color_Link_S)
        End If
      Next gLink
        ...
        With gLink
          ...
          Select Case Nb Mod 2
            Case 0
              ...
              sc_Cdd.G6_Cellule_Paint_Candidat(gLink.Cdd(0), Color.Green)
            Case Else
              Dim sc_cdd As New Cellule_Cls With {.Numéro = gLink.Cel(0)}
              sc_cdd.G6_Cellule_Paint_Candidat(gLink.Cdd(0), Color.Blue)
          End Select
        End With
      Next gLink
