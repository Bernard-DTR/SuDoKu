Friend Module M03_Sélection
  ...
  End Sub
  Sub Cell_Cdd_Exclude_CAG(Cellule As Integer)
    'Avant toute modification
    Dim Av_Jeu As String = Act_Jeu()
    Dim Av_AllCdd As String = Act_Candidats()
    Dim Candidats As String
    ...
    If Plcy_Gnrl = "Nrm" And Plcy_Strg = "CaG" Then
      ...
      Act_Add(Cellule, "Exclure_Cdd", "*", Candidats, Plcy_Strg, Av_Jeu, Av_AllCdd)
      Pbl_Cell_Select = Cellule
      Frm_SDK.B_Pourcentage.Text = Wh_Pourcentage()
      Exit Sub
    End If
  ...
  End Sub
  Sub Cell_Cdd_Copy_CAG(Cellule As Integer)
    If Plcy_Gnrl = "Nrm" And Plcy_Strg = "CaG" Then
      If U(Cellule, 3) <> " " Then
        CAG_Clipboard = U(Cellule, 3)
      End If
    End If
  End Sub
  Sub Cell_Cdd_Paste_CAG(Cellule As Integer)
    If Plcy_Gnrl = "Nrm" And Plcy_Strg = "CaG" And CAG_Clipboard <> Cnddts_Blancs Then
      For i As Integer = 1 To 9
        If CAG_Clipboard(i - 1) <> " " Then
          Cell_Cdd_Insert(CAG_Clipboard(i - 1), Cellule)
        End If
      Next
    End If
  End Sub
